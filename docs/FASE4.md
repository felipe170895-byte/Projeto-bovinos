...
## Observação
- Para o CSRF funcionar, os formulários POST recebem token automaticamente via `assets/js/app.js`.
- Em ambientes de alta segurança, também é recomendado incluir o token manualmente no HTML para suportar casos sem JavaScript.
